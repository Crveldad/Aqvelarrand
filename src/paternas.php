...
<body>
    <form action="fichaPersonaje.php" method="post">
        ...
        ?>
            ...
            <input type="text" name="<?= $competencias ?>" class="pat" id="<?= $competencias ?>" max="<?= competenciasMax($competencias, $p1->caracteristicas, $p1->getAspecto()) ?>" min="<?= $valor ?>" value="<?= $valor ?>">
